...
<div class="mx-auto flex max-w-md flex-col gap-y-4">
	...
	>
		...
		<Button
			variant="secondary"
			href="/login/google"
			class="flex w-full gap-x-3 text-lg font-normal"
		>
			<span>
		...
		<Button variant="secondary" class="w-full" onclick={authenticatePasskey}>
			<div class="pointer-events-none flex gap-x-1.5 text-lg font-normal">
				<span>
